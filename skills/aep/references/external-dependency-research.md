...
| `style: "sdk"` | the component codes against a vendor library — `sdk.json` names the package for YOUR language; the API slice beside it (when present) is the fallback for calls the SDK lacks |
